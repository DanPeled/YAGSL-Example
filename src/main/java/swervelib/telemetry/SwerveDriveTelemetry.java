...
/**
 * Telemetry to describe the {@link swervelib.SwerveDrive} following
 * frc-web-components. (Which follows AdvantageKit)
 */
public class SwerveDriveTelemetry {
  ...
  /**
   * An array of rotation and velocity values describing the measured state of
   * each swerve module
   */
  public static double[] measuredStates;
  /**
   * An array of rotation and velocity values describing the desired state of each
   * swerve module
   */
  ...
  /**
   * The maximum achievable speed of the modules, used to adjust the size of the
   * vectors.
   */
  public static Measure<Velocity<Distance>> maxSpeed;
  /**
  ...
  /**
   * The direction the robot should be facing when the "Robot Rotation" is zero or
   * blank. This option is often useful to
   * align with odometry data or match videos. 'up', 'right', 'down' or 'left'
   */
  public static String forwardDirection = "up";
  /**
   * The maximum achievable angular velocity of the robot. This is used to
   * visualize the angular velocity from the
   * chassis speeds properties.
   */
  public static Measure<Velocity<Angle>> maxAngularVelocity;
  /**
   * The maximum achievable angular velocity of the robot. This is used to
   * visualize the angular velocity from the
   * chassis speeds properties.
  ...
  public static void updateData() {
    ...
    SmartDashboard.putNumber("swerve/maxSpeed", maxSpeed.in(MetersPerSecond));
    ...
    SmartDashboard.putNumber("swerve/maxAngularVelocity", maxAngularVelocity.in(RadiansPerSecond));
