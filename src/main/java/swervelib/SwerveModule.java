...
public class SwerveModule {
   ...
   */
  public Measure<Velocity<Distance>> maxSpeed;
  /**
   ...
   */
  private Measure<Angle> angleOffset;
  /**
   ...
   */
  public void setAngleMotorVoltageCompensation(Measure<Voltage> optimalVoltage) {
   ...
   * @param optimalVoltage Nominal voltage for operation to output to.
   */
  public void setDriveMotorVoltageCompensation(Measure<Voltage> optimalVoltage) {
  ...
  public void setDesiredState(SwerveModuleState desiredState, boolean isOpenLoop, boolean force) {
    ...
    if (!force && antiJitterEnabled) {
      ...
      SwerveMath.antiJitter(desiredState, lastState, MetersPerSecond.of(Math.min(maxSpeed.in(MetersPerSecond), 4)));
    }
    ...
    if (isOpenLoop) {
      double percentOutput = desiredState.speedMetersPerSecond / maxSpeed.in(MetersPerSecond);
  ...
  public void restoreInternalOffset() {
    angleMotor.setAbsoluteEncoder(null);
    absoluteEncoder.setAbsoluteEncoderOffset(Degrees.of(0));
