...
public class SwerveModulePhysicalCharacteristics {
   ...
   */
  public final Measure<Current> driveMotorCurrentLimit, angleMotorCurrentLimit;
  /**
   * The time it takes for the motor to go from 0 to full throttle in seconds.
   */
  public final Measure<Time> driveMotorRampRate, angleMotorRampRate;
  /**
   ...
   */
  public Measure<Voltage> optimalVoltage;
  /**
   ...
   *
   * @param conversionFactors              The conversion factors for the drive
   *                                       and angle motors, created by
  ...
  public SwerveModulePhysicalCharacteristics(
      ...
      Measure<Current> driveMotorCurrentLimit,
      Measure<Current> angleMotorCurrentLimit,
      Measure<Time> driveMotorRampRate,
      Measure<Time> angleMotorRampRate) {
   ...
   *
   * @param conversionFactors  The conversion factors for the drive and angle
   *                           motors, created by
   *                           {@link swervelib.math.SwerveMath#calculateMetersPerRotation(double, double, double)}
   *                           and
   *                           {@link swervelib.math.SwerveMath#calculateDegreesPerSteeringRotation(double, double)}.
   * @param driveMotorRampRate The time in seconds to go from 0 to full throttle
   *                           on the motor. (Prevents over drawing
   *                           power from battery)
   * @param angleMotorRampRate The time in seconds to go from 0 to full throttle
   *                           on the motor. (Prevents overdrawing
