...
public class SwerveParser {
   ...
   */
  public SwerveDrive createSwerveDrive(Measure<Velocity<Distance>> maxSpeed) {
    return createSwerveDrive(SwerveMath.createDriveFeedforward(Volts.of(physicalPropertiesJson.optimalVoltage),
        maxSpeed,
   ...
   * @return {@link SwerveDrive} instance.
   */
  public SwerveDrive createSwerveDrive(Measure<Velocity<Distance>> maxSpeed, double angleMotorConversionFactor,
   ...
   * @return {@link SwerveDrive} instance.
   */
  public SwerveDrive createSwerveDrive(SimpleMotorFeedforward driveFeedforward, Measure<Velocity<Distance>> maxSpeed,
