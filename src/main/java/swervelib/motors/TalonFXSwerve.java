...
public class TalonFXSwerve extends SwerveMotor {
  ...
  public Measure<Voltage> getVoltage() {
    return Volts.of(motor.getMotorVoltage().waitForUpdate(STATUS_TIMEOUT_SECONDS).getValue());
  }
  ...
  public void setCurrentLimit(Measure<Current> currentLimit) {
    ...
    cfg.apply(
        configuration.CurrentLimits.withStatorCurrentLimit(currentLimit.in(Amps))
  ...
  public void setLoopRampRate(Measure<Time> rampRate) {
    ...
    cfg.apply(configuration.ClosedLoopRamps.withVoltageClosedLoopRampPeriod(rampRate.in(Seconds)));
  }
