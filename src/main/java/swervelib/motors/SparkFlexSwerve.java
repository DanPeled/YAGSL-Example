...
public class SparkFlexSwerve extends SwerveMotor {
  ...
  /**
   * An {@link Alert} for if the absolute encoder's offset is set in the json
   * instead of the hardware client.
   */
  ...
  public void setVoltageCompensation(Measure<Voltage> nominalVoltage) {
    configureSparkFlex(() -> motor.enableVoltageCompensation(nominalVoltage.in(Volts)));
  }
  ...
  public void setCurrentLimit(Measure<Current> currentLimit) {
    configureSparkFlex(() -> motor.setSmartCurrentLimit((int) currentLimit.in(Amps)));
  }
  ...
  public void setLoopRampRate(Measure<Time> rampRate) {
    configureSparkFlex(() -> motor.setOpenLoopRampRate(rampRate.in(Seconds)));
    configureSparkFlex(() -> motor.setClosedLoopRampRate(rampRate.in(Seconds)));
  }
  ...
  public void setReference(double setpoint, double feedforward) {
    ...
    if (isDriveMotor) {
      configureSparkFlex(() -> pid.setReference(
          setpoint,
  ...
  public double getVelocity() {
    return absoluteEncoder == null ? encoder.getVelocity() : absoluteEncoder.getVelocity().in(DegreesPerSecond);
  }
