...
public class TalonSRXSwerve extends SwerveMotor {
   ...
   */
  private Measure<Voltage> nominalVoltage = Volts.of(12.0);
   ...
   * @return Setpoint as native sensor units. Encoder ticks per 100ms, or Encoder
   *         tick.
   */
  public double convertToNativeSensorUnits(double setpoint, double position) {
    setpoint = isDriveMotor ? setpoint * .1
        : SwerveMath.placeInAppropriate0To360Scope(Degrees.of(position), Degrees.of(setpoint)).in(Degrees);
  ...
  public void setReference(double setpoint, double feedforward, double position) {
    ...
    motor.set(
        ...
        feedforward / nominalVoltage.in(Volts));
  }
  ...
  public void setVoltageCompensation(Measure<Voltage> nominalVoltage) {
    configuration.voltageCompSaturation = nominalVoltage.in(Volts);
    configChanged = true;
  ...
  public void setCurrentLimit(Measure<Current> currentLimit) {
    configuration.continuousCurrentLimit = (int) currentLimit.in(Amps);
    configuration.peakCurrentLimit = (int) currentLimit.in(Amps);
    configChanged = true;
  }
  ...
  public void setLoopRampRate(Measure<Time> rampRate) {
    configuration.closedloopRamp = rampRate.in(Seconds);
    configuration.openloopRamp = rampRate.in(Seconds);
    configChanged = true;
  }
