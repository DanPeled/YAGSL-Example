...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public Command aimAtSpeaker(double tolerance) {
    ...
    return run(
        () -> {
          drive(ChassisSpeeds.fromFieldRelativeSpeeds(MetersPerSecond.of(0),
              MetersPerSecond.of(0),
              controller.headingCalculate(Radians.of(getHeading().getRadians()),
                  Radians.of(getSpeakerYaw().getRadians())),
              getHeading()));
  ...
  public Command driveToPose(Pose2d pose) {
    ...
    PathConstraints constraints = new PathConstraints(
        swerveDrive.getMaximumVelocity().in(MetersPerSecond), 4.0,
        swerveDrive.getMaximumAngularVelocity().in(RadiansPerSecond), Units.degreesToRadians(720));
   ...
   *         given speed
   */
  public Command driveToDistanceCommand(Measure<Distance> distanceInMeters,
      Measure<Velocity<Distance>> speedInMetersPerSecond) {
    return Commands.deferredProxy(
        () -> Commands.run(() -> drive(new ChassisSpeeds(speedInMetersPerSecond.in(MetersPerSecond), 0, 0)), this)
  ...
  public void setMaximumSpeed(Measure<Velocity<Distance>> maximumSpeed) {
    swerveDrive.setMaximumSpeed(maximumSpeed, false,
        swerveDrive.swerveDriveConfiguration.physicalCharacteristics.optimalVoltage);
  }
  ...
  public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY,
    ...
    return run(() -> {
      ...
      swerveDrive.drive(SwerveMath.scaleTranslation(new Translation2d(
          translationX.getAsDouble() * swerveDrive.getMaximumVelocity().in(MetersPerSecond),
          translationY.getAsDouble() * swerveDrive.getMaximumVelocity().in(MetersPerSecond)), 0.8),
          Math.pow(angularRotationX.getAsDouble(), 3) * swerveDrive.getMaximumAngularVelocity().in(RadiansPerSecond),
          true,
          false);
    });
  }
